...
If `oracle-dev-db/` is not yet in this repo, copy it from [Oracle-skills](https://github.com/xamdxlonewolf/Oracle-skills) branch `cursor/oracle-dev-skill-ed6e`, folder `export/oracle-dev-copy/`, into `oracle-dev-db/`.

Then apply these **5 renames** (`oracle-dev` → `oracle-dev-db`):

**`oracle-dev-db/SKILL.md`**

| Find | Replace with |
|------|--------------|
| `name: oracle-dev` | `name: oracle-dev-db` |
| `oracle-dev/` (directory tree block only) | `oracle-dev-db/` |
| `.../cobb-dev-agent-skills/oracle-dev` | `.../cobb-dev-agent-skills/oracle-dev-db` |
| `Prefer \`oracle-dev/\`` | `Prefer \`oracle-dev-db/\`` |

**`oracle-dev-db/design/project-prefix.md`**

| Find | Replace with |
|------|--------------|
| `oracle-dev/design/schema-standards.md` | `oracle-dev-db/design/schema-standards.md` |

Source file URLs:

- https://github.com/xamdxlonewolf/Oracle-skills/tree/cursor/oracle-dev-skill-ed6e/export/oracle-dev-copy

Replace this repo's `README.md` with this file when done.
